...
class WaitTimeSchimitter:
    ...
    def waitTime(self, k: int):
        ...
        if self.FLAG_WAIT == 'upper' and k > self.thres_u:
...
if __name__ == '__main__':
    ...
    # IN = io.open(infile, 'r')
    outfile = 'D:/Documents/GitHub/BS-SNV-Caller/data/atcg.large.out5'
    ...
    wait = WaitTimeSchimitter(num_workers*20, num_workers*30, 1, 'lower')
